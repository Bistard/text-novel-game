...
const translations = {
	en: {
		...
		common: {
			...
			undoWarningToggleOn: "Undo Warning: Off",
			undoWarningToggleOff: "Undo Warning: On",
			undoWarningEnable: "Enable ignore undo warning",
			undoWarningDisable: "Disable ignore undo warning",
			undoWarningLabel: "Toggle undo warning prompt",
			choices: "Choices",
			journal: "Journal",
			stats: "Stats",
			inventory: "Inventory",
	...
	fr: {
		...
		common: {
			...
			undoWarningToggleOn: "l'avertissement d'annulation : activé",
			undoWarningToggleOff: "l'avertissement d'annulation : désactivé",
			undoWarningEnable: "Activer l'ignorance de l'avertissement d'annulation",
			undoWarningDisable: "Désactiver l'ignorance de l'avertissement d'annulation",
			undoWarningLabel: "Activer/désactiver l'avertissement d'annulation",
			choices: "Choix",
			journal: "Journal",
			stats: "Statistiques",
	...
	"zh-Hans": {
		...
		common: {
			...
			undoWarningToggleOn: "撤销警告：开启",
			undoWarningToggleOff: "撤销警告：关闭",
			undoWarningEnable: "启用忽略撤销警告",
			undoWarningDisable: "停用忽略撤销警告",
			undoWarningLabel: "切换忽略撤销警告",
			choices: "选项",
			journal: "日志",
			stats: "属性",
			inventory: "物品",
